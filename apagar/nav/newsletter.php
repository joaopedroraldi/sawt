<ul class="nav nav-pills">
  <li role="presentation" class="active"><a href="#">Contatos</a></li>
  <li role="presentation"><a href="?page=telefones">Telefones</a></li>
</ul>

<?php 
$query = "SELECT * FROM email_contato ORDER BY data DESC LIMIT ".$limite." OFFSET ".$offset;
...
?>
<a class="btn btn-default" href="?page=contatos&pagina=<?php echo $pagina-1; ?>"><i class="fa fa-step-backward" aria-hidden="true"></i></a>
<?php
}
if($rows_contato > 0){
?>
<a class="btn btn-default" href="?page=contatos&pagina=<?php echo $pagina+1; ?>"><i class="fa fa-step-forward" aria-hidden="true"></i></a>
<?php } ?>