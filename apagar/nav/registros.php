<?php 
  ...
  if(isset($_GET['cat'])){
    ...
    $query = "SELECT 
    registros_id, registros_titulo, registros_imagem, registros_texto, registros_notificacao,
        ...
        <tr style="width:100%">
           <?php if($_GET['id'] == 55){ ?>
            ...
            <?php if($_GET['id'] == 55){ ?>
                ...
                <a target="_blank" href="?page=contratogerado&id=<?php echo $row_registros['registros_id'] ?>"><button type="button" class="btn btn-xs btn-success"><?php if($row_registros['registros_notificacao'] > 0){echo '<i class="fa fa-envelope"></i>';} ?> <i class="fa fa-check"></i> Contrato gerado</button></a>       
                <?php } ?>
