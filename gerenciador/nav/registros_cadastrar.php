...
<div class="row">
    <div class="col-lg-12">
        <form id="registros_cadastrar" method="post" enctype="multipart/form-data" class="form">
            ...
            <input type="hidden" name="registros_cliente_key" value="<?php echo md5(time()); ?>">
            <div class="form-group">
            ...
            <div class="form-group">
                <label>CEP</label>
                <input name="registros_cep" class="form-control cep" type="text">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="registros_endereco" class="form-control rua" type="text">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Número</label>
                        <input name="registros_numero" class="form-control" type="text">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Bairro</label>
                        <input name="registros_bairro" class="form-control bairro" type="text">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Cidade</label>
                        <input name="registros_cidade" class="form-control cidade" type="text">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Estado</label>
                        <input name="registros_estado" class="form-control estado" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label>Valor</label>
                <input name="registros_valor" class="form-control valor" type="text">
            </div>
            <div class="form-group">
