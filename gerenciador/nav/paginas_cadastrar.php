    ...
    <div class="col-lg-12">
        <form id="paginas_cadastrar" method="post" enctype="multipart/form-data" class="form">
            ...
            <div class="form-group">
                ...
                <label><input type="checkbox" value="1" name="paginas_permissoes[]"> Vendedor</label> <br>
                <label><input type="checkbox" value="0" name="paginas_permissoes[]"> Desenvolvedor</label>
            </div>
