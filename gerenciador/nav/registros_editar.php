...
<div class="row">
    <div class="col-lg-12">
        <form id="registros_editar" method="post" enctype="multipart/form-data" class="form">
            ...
            <div class="form-group">
                <label>CEP</label>
                <input name="registros_cep" class="form-control cep" type="text" value="<?php echo $row_registros['registros_cep'] ?>">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="registros_endereco" class="form-control rua" type="text" value="<?php echo $row_registros['registros_endereco'] ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Número</label>
                        <input name="registros_numero" class="form-control" type="text" value="<?php echo $row_registros['registros_numero'] ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Bairro</label>
                        <input name="registros_bairro" class="form-control bairro" type="text" value="<?php echo $row_registros['registros_bairro'] ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Cidade</label>
                        <input name="registros_cidade" class="form-control cidade" type="text" value="<?php echo $row_registros['registros_cidade'] ?>">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Estado</label>
                        <input name="registros_estado" class="form-control estado" type="text" value="<?php echo $row_registros['registros_estado'] ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Valor</label>
                <input name="registros_valor" class="form-control valor" type="text" value="<?php echo $row_registros['registros_valor'] ?>">
            </div>
            <div class="form-group">
