...
if($response != null && $response->success){
	...
	$mensagem = "
		...
		<table cellpadding=10>
			<tr>
				<td><b>O que deverá ser feito?</b></td>
				<td>$br_pergunta_1</td>
			</tr>
			<tr>
				<td><b>Quais as medidas do material?</b></td>
				<td>$br_pergunta_2</td>
			</tr>
			<tr>
				<td><b>Onde será aplicado/colocado/utilizado?</b></td>
				<td>$br_pergunta_3</td>
			</tr>
			<tr>
				<td><b>Quais cores devem ser utilizadas?</b></td>
				<td>$br_pergunta_4</td>
			</tr>
			<tr>
				<td><b>Qual é a ideia da comunicação?</b></td>
				<td>$br_pergunta_5</td>
			</tr>
			<tr>
				<td><b>Dê exemplos de como gostaria?</b></td>
				<td>$br_pergunta_6</td>
			</tr>
		</table>";
